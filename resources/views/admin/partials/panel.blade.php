<aside id="column-left" class="col-lg-3 col-md-3 col-sm-12 hidden-xs" style="background-color: rgba(43,84,44,0.2); height: 600px; width: 250px">
    ...
    <div class="box-category">
        <ul id="cat_accordion">
            ...
            <li>
                <a href="{{route('admin.albums.create')}}">آپلود آلبوم </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{route('admin.albums.list')}}">لیست آلبوم ها </a>
            </li>
            <li>
                <a href="{{route('admin.payments.list')}}">پرداخت ها </a>
            </li>
            <li>
                <a href="{{route('admin.categories.create')}}">ایجاد دسته بندی جدید </a>
            </li>
            <li>
                <a href="{{route('admin.categories.list')}}">لیست دسته بندی ها </a>
            </li>
        </ul>
    </div>
</aside>