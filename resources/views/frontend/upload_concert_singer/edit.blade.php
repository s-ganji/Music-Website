            ...
            <div class="col-sm-9" id="content">
                ...
                <form class="text-center " method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">زمان برگزاری کنسرت : </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="clock" placeholder="زمان برگزاری کنسرت را وارد نمایید " value="{{old('clock',isset($concertItem) ? $concertItem->clock : '')}}" name="clock">
                            </div>
                        </div>
                        <br>
                        <br>
