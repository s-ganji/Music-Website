                   ...
                   <!-- <div class="psdown">
                    ...
                    <div class="pscn1">
                        <div class="lnkdl animate">
                            <a href="#"> (یکجا)دانلود آلبوم با کیفیت 320</a>
                            <a href="#"> (تکی)دانلود آلبوم با کیفیت 320</a>
                            <a href="#">(یکجا)دانلود آلبوم با کیفیت 128</a>
                            <a href="#">(تکی)دانلود آلبوم با کیفیت 128</a>
                        </div>
