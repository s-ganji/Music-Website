    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu_brands dropdown"><a href="#">دانلود موزیک ویدئو</a>
                </li>
                <li class="menu_brands dropdown"><a href="download_album.html">دانلود آلبوم</a>
                </li>
                <li class="menu_brands dropdown"><a href="download_concert1.html">کنسرت ها</a>
                </li>            <li class="dropdown information-link"><a>گالری</a>
...
<?php /**PATH C:\xampp\htdocs\laramusic\resources\views/users/partials/nav.blade.php ENDPATH**/ ?>