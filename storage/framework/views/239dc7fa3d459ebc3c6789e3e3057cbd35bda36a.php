<head>
    ...
    <link href="<?php echo e(asset('image/hi.png')); ?>" rel="icon" />
    <title>تاپ میوزیک</title>
    <meta name="description" content="Responsive and clean html template design for any kind of ecommerce webshop">
    <!-- CSS Part Start-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('js/bootstrap/css/bootstrap.min.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('js/bootstrap/css/bootstrap-rtl.min.css')); ?>" />
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/stylesheet-rtl.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/responsive-rtl.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/stylesheet-skin3.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('bower_components\select2\dist\css\select2.min.css')); ?>" />



    <!-- panel ADMIN -->
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="<?php echo e(asset('dist/css/bootstrap-theme.css')); ?>">
    <!-- Bootstrap rtl -->
    <link rel="stylesheet" href="<?php echo e(asset('dist/css/rtl.css')); ?>">
    <!-- Font Awesome -->
    ...
    <!-- Google Font -->
    <link rel="stylesheet"
          href="<?php echo e(asset('css/css.css')); ?>">

    <!-- CSS Part End-->
</head><?php /**PATH C:\xampp\htdocs\laramusic\resources\views/admin/partials/head.blade.php ENDPATH**/ ?>