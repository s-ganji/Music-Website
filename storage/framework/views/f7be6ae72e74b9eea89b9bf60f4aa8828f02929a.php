<head>
    ...
    <link  href="<?php echo e(asset('/css/select2.min.css')); ?>">
    <!-- panel ADMIN -->
    <!-- Bootstrap 3.3.7 -->
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via music:// -->
    <!--[if lt IE 9]>
    ...
    <!-- CSS Part End-->
</head><?php /**PATH C:\xampp\htdocs\laramusic\resources\views/users/partials/head.blade.php ENDPATH**/ ?>