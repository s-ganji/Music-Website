...
<div id="content" class="col-lg-7 col-md-7 col-sm-12">
                ...
                <div class="ps anm">
                    ...
                    <div class="pscn1">
                        <div class="lnkdl animate">
                            <a href="#">دانلود آهنگ با کیفیت اصلی</a>
                            <a href="#">دانلود آهنگ با کیفیت 128</a>
                        </div>
                        <br>
                        <div class="cdfblg">
                        ...
                        <br>
                        <h4>پخش آنلاین آهنگ با کیفیت اصلی</h4>
                        <audio controls class="oudio">
                            <source src="../songs/<?php echo e($music->file_name); ?>" type="audio/mpeg">
                        </audio>
    ...
    <?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\laramusic\resources\views/frontend/download_music/middlemain.blade.php ENDPATH**/ ?>