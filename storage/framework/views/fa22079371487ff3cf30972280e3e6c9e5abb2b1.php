...
<div class="wrapper-wide">
    ...
    <div id="container">
        <div class="container-fluid" style="width: 98%;">
            <!--carousol start-->
        <?php echo $__env->make('frontend.partials.carousel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--carousol end-->
            <!--picture start-->
        <?php echo $__env->make('frontend.partials.picture', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--picture end-->
            <div class="row">
                <!--rightcategory start-->
...
</html><?php /**PATH C:\xampp\htdocs\laramusic\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>