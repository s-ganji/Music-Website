    ...
    <div class="container">
        <div class="table-container">
            ...
            <div class="col-table-cell col-lg-4 col-md-4 col-sm-12 col-xs-12 inner">
                <div id="logo"><a href="index.html"><img class="myImage" src="<?php echo e(asset('image/hi.png')); ?>"  title="Top Music" alt="MarketShop" /><span style="font-size: 27px ;   text-shadow: 2px 2px 5px rgb(87, 94, 92);"> وب سایت تاپ موزیک </span></a>
            ...
            <div class="col-md-1 col-table-cell col-lg-3 col-md-pull-0 col-sm-6 col-sm-pull-6 col-xs-12 inner">
                ...
                <a href="<?php echo e(route('frontend.users.register')); ?>"> <button class="btn btn-success btn-sm" onClick=""  style="border-radius: 5px;padding: 5px;margin: 5px;float: left;" > ثبت نام  </button></a>
                <a href="<?php echo e(route('frontend.users.login')); ?>"> <button class="btn btn-success btn-sm" onClick="" style="border-radius: 5px;padding: 5px;margin: 5px;float: left;"> ورود  </button></a>
                    <?php else: ?>
                    <div style="float: left" class="col-md-11">
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:darkgreen;font-size: 20px">
...
<?php /**PATH C:\xampp\htdocs\laramusic\resources\views/admin/partials/header.blade.php ENDPATH**/ ?>