            ...
            <div class="ps anm">
                ...
                <div class="pcnt">
                    <div class="center">
                        ...
                        <p>
                            <img src="<?php echo e(asset($music->image_name)); ?>"
                ...
                <div class="psdown">
                    ...
                    <a href="<?php echo e(route('frontend.musics.details',$music->id)); ?>" class="more">دانلود آهنگ</a>
                </div>
            </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\laramusic\resources\views/frontend/home/middlemain.blade.php ENDPATH**/ ?>