                    ...
                    <form class="form-horizontal" method="post">
                        ...
                        <fieldset id="account">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="F_name" placeholder="نام"
                                           value="<?php echo e(old('F_name')); ?>" name="F_name">
                                </div>
                            </div>
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="E_name"
                                           placeholder="نام خانوادگی" value="<?php echo e(old('E_name')); ?>" name="E_name">
                                </div>
                            </div>
                            <div class="form-group required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" id="phone" placeholder="شماره تلفن" value="<?php echo e(old('phone')); ?>"
                                           name="phone">
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="role" name="role">
                                        <option value="<?php echo e(old('role')); ?>"> --- لطفا انتخاب کنید ---</option>
                        ...
                        <fieldset id="address">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="city" placeholder="شهر" value="<?php echo e(old('city')); ?>"
                                           name="city">
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="state" name="state">
                                        <option value="<?php echo e(old('state')); ?>"> --- لطفا انتخاب کنید ---</option>
...
<?php echo $__env->make('layouts.users', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laramusic\resources\views/frontend/users/register.blade.php ENDPATH**/ ?>