...
class MusicVideoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $result = $request->file('musicvideoItem')->move(public_path('songs'), $new_musicvideo_name);
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.musicvideo.edit', compact('musicvideoItem'));
    ...
    public function update(Request $Request, $id)
    {
        ...
        if ($updated_musicvideo) {
            return redirect()->route('admin.musicvideo.list')->with('success', 'اطلاعات  مورد نظر با موفقیت به روزرسانی شد');
